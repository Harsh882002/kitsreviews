      ...
      <div className="bg-white/10 backdrop-blur-md p-4 sm:p-6 rounded-2xl max-w-5xl w-full shadow-lg border border-white/30 space-y-6">
        ...
        <div className="flex flex-wrap justify-center sm:justify-between gap-3 mb-6">
          <button
            ...
            className="bg-yellow-400 text-indigo-900 font-bold px-4 py-2 rounded-xl hover:bg-yellow-500 transition"
          >
          ...
          <button
            ...
            className="bg-red-600 hover:bg-red-700 text-white font-bold px-4 py-2 rounded-xl transition"
          >
            🚪 Logout
          </button>
        </div>
